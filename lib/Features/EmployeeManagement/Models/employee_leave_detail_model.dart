class EmployeeLeaveDetailResponse {
  final String message;
  final EmployeeData data;

  EmployeeLeaveDetailResponse({required this.message, required this.data});

  factory EmployeeLeaveDetailResponse.fromJson(Map<String, dynamic> json) {
    return EmployeeLeaveDetailResponse(
