...
class EmployeeProfileDetails extends StatelessWidget {
  const EmployeeProfileDetails({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 10.sp,
            children: const [
              CustomBorderTextForm(title: "User Name"),
              CustomBorderTextForm(title: "Password"),
              CustomBorderDropDownForm(hintText: "Department"),
              CustomBorderDropDownForm(hintText: "Designation"),
              CustomBorderTextForm(title: "Basic Salary"),
              CustomBorderDropDownForm(hintText: "Work Shift"),
              CustomBorderDropDownForm(hintText: "User Type"),
            ],
          ),
          10.height,
          SizedBox(
