...
class AttendancePdfGenerator {
  ...
  static pw.Widget _buildHeader(
    ...
    if (attendanceData.records.isNotEmpty) {
      List<String> dates =
          attendanceData.records.map((r) => r.date).toSet().toList();
      dates.sort();
      if (dates.length == 1) {
          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  'Total Records: ${attendanceData.records.length}',
                  style: pw.TextStyle(fontSize: 10),
                ),
              ],
            ),
  ...
  static pw.Widget _buildSummarySection(AttendanceListModel attendanceData) {
    ...
    int overtimeCount =
        attendanceData.records.where((r) => r.isOvertime).length;
            ...
            children: [
              ...
              ...departmentGroups.entries.map((entry) {
                ...
                int present =
                    entry.value
                        .where(
                          (r) => r.presentOne == '1' || r.presentTwo == '1',
                        )
                        .length;
  ...
  Future<void> generateEmployeeAttendanceSheet(
    ...
    await _savePdf(
      pdf,
      'attendance_${employee.employeeName}_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  }
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              ...
              _buildStatItem(
                'Avg Hours/Day',
                '${(totalHours / totalDays).toStringAsFixed(1)}h',
              ),
            ],
          ),
        ],
  ...
  static pw.Widget _buildEmployeeAttendanceTable(
  ...
  Future<void> generateMonthlyAttendanceSummary(
    ...
    await _savePdf(
      pdf,
      'monthly_attendance_${month}_${year}_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  }
