...
import 'package:act/Features/Report/payroll_generater.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildSummaryItem(
                          'Records',
                          widget.payrollData.payrollRecords.length.toString(),
                        ),
                      ],
                    ),
                  ],
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed:
                        _isGenerating ? null : () => _showEmployeeSelection(),
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final record =
                              widget.payrollData.payrollRecords[index];
                          return ListTile(
                            ...
                            subtitle: Text(
                              '${record.department} | ${record.month}',
                            ),
                            trailing: Column(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Payslip for ${record.employeeName} generated successfully!',
            ),
            backgroundColor: Colors.green,
          ),
        );
